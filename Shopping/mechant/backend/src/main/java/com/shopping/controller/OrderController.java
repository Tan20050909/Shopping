...
public class OrderController {
    ...
    public Logistics ship(@PathVariable Long id, @RequestBody Map<String, String> body) {
        ...
        Long merchantId = body.get("merchantId") == null ? null : Long.valueOf(body.get("merchantId"));
        if (merchantId == null) {
        ...
        return logisticsService.shipOrder(id, merchantId, expressCompany, expressNo);
    }
}
