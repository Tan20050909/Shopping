      ...
      <div v-else-if="afterSale" class="content">
        ...
        <el-card shadow="never" class="block">
          ...
          <el-form label-position="top">
            ...
            <el-form-item>
              <el-button type="success" :disabled="afterSale.status !== 0" @click="confirmHandle(1)">同意</el-button>
              <el-button type="danger" :disabled="afterSale.status !== 0" @click="confirmHandle(2)">拒绝</el-button>
              <el-button v-if="showCompleteBtn" plain :disabled="!canComplete" @click="confirmComplete">标记完成</el-button>
            </el-form-item>
          </el-form>
