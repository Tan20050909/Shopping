    ...
    <div class="page-head">
      ...
      <div class="head-actions">
        <el-date-picker
          ...
          class="plan-picker"
        />
        <el-button v-if="!isCreate" plain @click="toggleShelf">{{ form.status === 1 ? '下架' : '上架' }}</el-button>
      ...
      <el-tabs v-model="activeTab">
        <el-tab-pane label="商品详情" name="detail">
          <el-descriptions :column="2" border>
            ...
            <el-descriptions-item label="状态">{{ form.status === 1 ? '上架中' : '未上架' }}</el-descriptions-item>
            <el-descriptions-item label="审核">{{ form.auditStatus === 1 ? '已通过' : '待审核' }}</el-descriptions-item>
          </el-descriptions>
        </el-tab-pane>
