...
const loadDashboardData = async () => {
  ...
  merchantStatus.value = Number(merchantRes?.data?.status ?? 1)
  merchantAuditStatus.value = Number(merchantRes?.data?.auditStatus ?? 1)
  merchantAuditRemark.value = merchantRes?.data?.auditRemark || ''
