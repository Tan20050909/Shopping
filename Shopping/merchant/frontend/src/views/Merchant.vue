  ...
  <div class="merchant-page">
    <el-card class="card" shadow="never">
      ...
      <div class="audit-row">
        ...
        <el-tag v-if="merchant.status===3" type="danger" style="margin-left:8px">平台冻结</el-tag>
        <el-tag v-else-if="merchant.status===1" type="success" style="margin-left:8px">营业中</el-tag>
        <el-tag v-else type="info" style="margin-left:8px">未营业</el-tag>
        <span class="audit-tip">粉丝数：{{ merchant.followerCount ?? 0 }}</span>
      </div>
      <div v-if="merchant.auditRemark" class="audit-row" style="margin-top:8px">
        <span class="audit-tip" style="color:#f56c6c">原因：{{ merchant.auditRemark }}</span>
      </div>
      <div class="audit-row">
